...
from main_app.models import (
    RealEstateListing, VideoGame, BillingInfo, Invoice, Technology, Project, Programmer, Task, Exercise
)
...
#     print('- ' + task.title)
#
# task_1 = Task.objects.get(title="Task 1")
# task_2 = Task.objects.get(title="Task 2")
# task_3 = Task.objects.get(title="Task 3")
# # 4. Get recent completed tasks
# recent_completed = task_1.recent_completed_tasks(days=5)
