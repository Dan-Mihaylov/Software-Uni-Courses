...
CREATE TABLE IF NOT EXISTS stadiums (
    ...
    CONSTRAINT fk_stadiums_towns
            FOREIGN KEY (town_id)
            REFERENCES towns(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS teams (
    ...
    CONSTRAINT fk_teams_stadiums
            ...
            REFERENCES stadiums(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS players (
    ...
    CONSTRAINT fk_players_skills_data
            ...
            REFERENCES skills_data(id) ON DELETE CASCADE ON UPDATE CASCADE,
