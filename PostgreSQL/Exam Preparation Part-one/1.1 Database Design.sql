...
CREATE TABLE IF NOT EXISTS cages (
    ...
    CONSTRAINT fk_cages_animal_types
        ...
        REFERENCES animal_types(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS volunteers (
    ...
    CONSTRAINT fk_volunteers_volunteers_departments
        ...
        REFERENCES volunteers_departments(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS animals_cages (
    ...
    CONSTRAINT fk_animals_cages_cages
        FOREIGN KEY (cage_id)
        REFERENCES cages(id) ON DELETE CASCADE ON UPDATE CASCADE,
